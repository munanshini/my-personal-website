  ...
  return (
    <ThemeProvider>
      ...
      <div className="page-shell min-h-screen bg-paper text-ink">
        ...
        {page !== 'index' && <footer className="px-6 py-9 sm:px-8 md:pb-24">
        ...
        <SpotlightCard className="spotlight-card--assistant spotlight-card--cta spotlight-card--glass fixed bottom-5 left-1/2 z-[90] m-0 w-fit -translate-x-1/2" spotlightColor="rgba(56, 189, 248, .40)"><button
          type="button"
          onClick={() => setAssistantOpen(true)}
          aria-label="问我的 AI 助手"
          className="flex items-center gap-2 rounded-full px-5 py-3.5 text-xs font-semibold sm:px-6 sm:py-4 sm:text-sm"
        >
          <Sparkles size={15} />
