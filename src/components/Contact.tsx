    ...
    <footer id="contact" className="relative overflow-hidden border-t border-black/10 bg-[#e8e2d8] px-5 py-20 text-ink transition-colors duration-700 sm:px-8 md:py-28">
      <div className="relative z-10 mx-auto w-full max-w-canvas">
        ...
        <div className="mt-12 grid gap-6 lg:grid-cols-[1.2fr_.8fr]">
          <div className="relative min-h-[420px] overflow-hidden rounded-[2rem] bg-[#111417] p-7 text-white sm:p-10">
            ...
            <div className="relative z-10 flex h-full flex-col justify-between">
              ...
              <a href="mailto:zn525347603@gmail.com" className="group flex items-end justify-between border-b border-white/30 pb-5">
          ...
          <div className="rounded-[2rem] border border-black/15 bg-white/45 p-7 sm:p-10">
            ...
            <div className="mt-8 divide-y divide-black/10 border-y border-black/10 text-sm">
              <div className="grid grid-cols-[1fr_minmax(0,1fr)_auto] items-center gap-3 py-4"><span>电话</span><a href="tel:15767978588" className="text-right font-bold hover:text-signal">15767978588</a><CopyButton value="15767978588" label="电话" /></div>
              <div className="grid grid-cols-[1fr_minmax(0,1fr)_auto] items-center gap-3 py-4"><span>邮箱</span><a href="mailto:zn525347603@gmail.com" className="text-right font-bold hover:text-signal">zn525347603@gmail.com</a><CopyButton value="zn525347603@gmail.com" label="邮箱" /></div>
              <div className="grid grid-cols-[1fr_minmax(0,1fr)_auto] items-center gap-3 py-4"><span>微信</span><strong className="text-right">15767978588</strong><CopyButton value="15767978588" label="微信" /></div>
            </div>
            <img src={wechatQr} alt="添加张楠微信的二维码" className="mt-7 h-40 w-40 rounded-2xl object-cover" />
